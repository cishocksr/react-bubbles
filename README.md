...
- [ ] Explain what a token is used for.
      Token is a state-less string that contains data that is stored and sent with a request. Goes through JWT where it encrypts the data. Token is a public data that anyone can change through the server.

- [ ] What steps can you take in your web apps to keep your data secure?
      Within the web app we can use can run test, keep the site upto date, make sure the login authorization is secure

- [ ] Describe how web servers work.
      They process incoming requests over different types of protocalls including HTTP. The primary function is to store, proces, and deliver information between the server and the client
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Post is the Create, Get is the Read, Put is the update, and Delete is the delete.
